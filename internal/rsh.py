...
This file is from the torchsh repo:
https://github.com/cheind/torch-spherical-harmonics/blob/main/torchsh/rsh.py
...
def rsh_cart_4(xyz: torch.Tensor):
    ...
    return torch.stack(
        [
            # torch.tensor(0.282094791773878,
            #              device=device, dtype=dtype
            #              ).expand_as(x),
            0 * x + 0.282094791773878,
            -0.48860251190292 * y,
            0.48860251190292 * z,
            -0.48860251190292 * x,
            1.09254843059208 * xy,
        ...
        [
            ...
            * (
                    ...
                    * (
                            ...
                            * z
                            * (1.66666666666667 * z * (
                                1.5 * z2 - 0.5) - 0.666666666666667 * z)
                            - 1.125 * z2
                            + 0.375
                    )
                    + 0.533333333333333 * z
